System.register(['@angular/core', '@angular/http', 'rxjs/add/operator/toPromise'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (_1) {}],
        execute: function() {
            ServiceCaterogiesModules = (function () {
                function ServiceCaterogiesModules(http) {
                    this.http = http;
                    this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
                }
                ServiceCaterogiesModules.prototype.getCategories = function () {
                ...
                ServiceCaterogiesModules = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [http_1.Http])
                ], ServiceCaterogiesModules);
                return ServiceCaterogiesModules;
            }());
            exports_1("ServiceCaterogiesModules", ServiceCaterogiesModules);
        }
    }
});
